...
//       multimap < string, int > * mvocab;
      ...
      float getSimilarityProb(string& s1,string& s2);
      float getSimilarityProb(char * s1,char * s2);
      float getDistanceProb(string& s1,string& s2);
      float getDistanceProb(char * s1,char * s2);
